...
function Register() {
    ...
    return (
        <div className="row">
            {
                hasError && !data.nom && !data.prenom && !data.adressEmail && !data.password ? <div className="alert alert-danger text-center" role="alert" >
                    Noooooooo!
                </div> : null
            }
            <h1 className="text-center text-primary">Join Us</h1>
            <form className="offset-md-3 col-md-6" onSubmit={onSubmit}>
                <div className="mb-3">
                ...
                <div className="mb-3">
                    ...
                    <input type="email" className="form-control" id="email" name="adressEmail" onChange={handleChange} />
